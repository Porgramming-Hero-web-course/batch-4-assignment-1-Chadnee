...
//function of validate keys and I take here also a string as element of union for make flexible to take another wrong word which is not property thats why it can show a false result, as typescript is so much strict to take another data type of object and it is a requirement of assignment that false result have to show also for wrong word which is not property of object.
